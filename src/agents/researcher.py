SYSTEM_PROMPT = """
    ...
    If theme matches the skill, ALWAYS follow the arrangement process of the most relevant skill.
    ...
    3. Prioritize using Google tools to obtain high-quality information.
"""


RESEARCHER_AGENT = {
    "name": "researcher_agent",
    "description": "A professional Web Search Agent responsible for retrieving timely, accurate, and relevant information(code、news、image) from the internet.",
